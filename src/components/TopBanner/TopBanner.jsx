  ...
  return (
    <div className='relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1'>
      ...
      <div className='flex  flex-wrap items-center gap-x-4 gap-y-2'>
        <p className='md:text-sm text-xs leading-6 text-gray-900 text-center'>
          <strong className='font-semibold hidden md:inline'>AutoShow 2023</strong>
          <svg viewBox='0 0 2 2' className='mx-2 h-0.5 w-0.5 fill-current hidden md:inline' aria-hidden='true'>
            <circle cx={1} cy={1} r={1} />
          </svg>
          منتظر شما هستیم از اول تا پانزدهم شهریور ماه در سالن نمایشگاه ماشین تهران بزرگ
        </p>
      </div>
